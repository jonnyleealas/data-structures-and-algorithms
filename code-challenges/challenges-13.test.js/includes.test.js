...
const standardizePhoneNumbers = (arr) => arr.map(phoneNumber => `${phoneNumber.substring(1,4)}${phoneNumber.substring(6,9)}${phoneNumber.substring(10,15)}`)
...
const onlyOddChars = (str) => [...str].reduce((value, current, i) => i%2 !== 0 ?value += current : value, '');
